...
import { FaClipboardCheck, FaClock, FaClockRotateLeft, FaPalette } from 'react-icons/fa6';

const Hero2 = () => {
  return (
    <div className='width-full h-auto lg:h-screen flex items-center justify-center bg-neutral-900 overflow-hidden relative'>
      <div className="absolute inset-0 z-0">
      {/* Particles as background */}
        <Particle />
      </div>
      <div className='relative z-10 w-[90%] my-[6rem] md:my-2rem grid-cols-1 mx-auto grid lg:grid-cols-3 gap-[3rem] h-[100%] items-center'>
        {/* Left container */}
        <div className='min-w-1/3 mx-[0.8rem] md:mx-auto gap-4 relative z-10'>
          <div>
        ...
        <div className='min-w-1/3 mx-[0.8rem] md:mx-auto gap-4 relative z-10'>
          <div>
            <h1 className='text-[1.7rem] md:text-[2.5rem] text-gray-300 mb-[2rem] '>
                Información
                <span className='text-gray-100'> destacada.</span>
            </h1>
            {/* Descriptions */}
            <div className='flex items-center space-x-4 mb-4'>
              <FaClock className='w-[2rem] h-[2rem] text-[#e84624] ' />
              <p className='text-[20px] text-stone-400 mb-4'>
                Más de 3 años de experiencia en desarrollo web.
              </p>
            </div>
            <div className='flex items-center space-x-4 mb-4'>
              <FaPalette className='w-[2rem] h-[2rem] text-[#e84624] ' />
              <p className='text-[20px] text-stone-400 mb-4'>
                Más de 2 años de experiencia en diseño UI/UX.
              </p>
            </div>
            <div className='flex items-center space-x-4 mb-4'>
              <FaClipboardCheck className='w-[2rem] h-[2rem] text-[#e84624] ' />
              <p className='text-[20px] text-stone-400 mb-4'>
                Más de 20 proyectos finalizados.
              </p>
            </div>
            <div className='flex items-center space-x-4 mb-4'>
              <FaClockRotateLeft className='w-[2rem] h-[2rem] text-[#e84624] ' />
              <p className='text-[20px] text-stone-400 mb-4'>
